...
class TestLstmManyToMany(unittest.TestCase):
    def test_toy_example(self):
        ...
        A number of evaluation results {seed:MSE, 0: 3202, 1:2762, 2:2656, 3:2574, 4:3177 }
        '''
        ...
        def train_model(model, number_of_training_epochs, train_input_output_tensor_list):
            ...
            for i in range(number_of_training_epochs):
                ...
                for train_input_tensor, train_output_tensor in train_input_output_tensor_list:
                    ...
                    loss_of_a_batch = loss_function(predicted_train_output_tensor, train_output_tensor)  # note that batch size is always 1
